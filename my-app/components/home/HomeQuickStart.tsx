...
export default function HomeQuickStart() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl mt-8 px-4">
      <Card className="group border-none bg-white/90 shadow-md backdrop-blur-sm transition-all duration-300 hover:z-10 hover:scale-105 hover:bg-white hover:shadow-2xl">
      ...
      <Card className="group border-none bg-white/90 shadow-md backdrop-blur-sm transition-all duration-300 hover:z-10 hover:scale-105 hover:bg-white hover:shadow-2xl sm:col-span-2 lg:col-span-1">
        <CardContent className="flex items-center gap-4 p-6">
